namespace CarInsuranceBot.Core.Const
{
    public class OpenaiKeywords
    {
        ...
        public const string LiveChattingRequest = "Please execute following request {0}, if it is related to the topic of Insurance and Vehicle Ownership, or any relevant matters, proceed accordingly. If not, just respond that the request is not appropriate.";
